...
export declare class UpdateBinder<C extends Command, I extends Interaction<D>, D extends InteractionData> extends Binder<C, I, D> implements CmdUpdateBinder<C>, InteractionCmdUpdateBinder<C, I, D> {
    ...
    constructor(undoHistory: UndoHistoryBase, logger: Logger, observer?: BindingsObserver, binder?: Partial<UpdateBinder<C, I, D>>);
    ...
    when(fn: (i: D) => boolean, mode?: WhenType): UpdateBinder<C, I, D>;
    ...
    toProduceAnon(fn: () => void): UpdateBinder<AnonCmd, I, D>;
