...
export declare class AnonBinding<C extends Command, I extends Interaction<D>, D extends InteractionData> extends BindingImpl<C, I, D> {
    ...
    constructor(continuousExec: boolean, interaction: I, undoHistory: UndoHistory, cmdSupplierFn: (d: D) => C, widgets: ReadonlyArray<EventTarget>, dynamicNodes: ReadonlyArray<Node>, strict: boolean, loggers: ReadonlyArray<LogLevel>, timeoutThrottle: number, stopPropagation: boolean, prevDefault: boolean, firstFn?: (c: C, i: D) => void, thenFn?: (c: C, i: D) => void, whenFn?: (i: D) => boolean, endFn?: (c: C, i: D) => void, cancelFn?: (i: D) => void, endOrCancelFn?: (i: D) => void, hadEffectsFn?: (c: C, i: D) => void, hadNoEffectFn?: (c: C, i: D) => void, cannotExecFn?: (c: C, i: D) => void, onErrFn?: (ex: unknown) => void);
