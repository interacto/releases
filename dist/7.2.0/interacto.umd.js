(function (global, factory) {
    ...
    })(exports.WhenType || (exports.WhenType = {}));
    function isWhenAtStart(type) {
        return type === exports.WhenType.strictStart || type === exports.WhenType.then || type === exports.WhenType.nonStrict || type === exports.WhenType.strict;
    }
    function isWhenAtThen(type) {
        return type === exports.WhenType.strictThen || type === exports.WhenType.then || type === exports.WhenType.nonStrict || type === exports.WhenType.strict;
    }
    function isWhenAtEnd(type) {
        return type === exports.WhenType.end || type === exports.WhenType.nonStrict || type === exports.WhenType.strict;
    }
    function isWhenStrict(type) {
        return type === exports.WhenType.end || type === exports.WhenType.strict || type === exports.WhenType.strictThen || type === exports.WhenType.strictStart;
    }

    class Bindings {
    }

    exports.CmdStatus = void 0;
    (function (CmdStatus) {
    ...
    class Binder {
        ...
        when(fn, mode = exports.WhenType.nonStrict) {
            const dup = this.duplicate();
    ...
    ***************************************************************************** */
    ...
    class KeysBinder extends UpdateBinder {
        ...
        completeWhenWithKeysPredicates() {
            ...
            this.whenFnArray.push({
                "fn": checkCodeFn,
                "type": exports.WhenType.nonStrict
            });
        }
    ...
    class EscapeKeyPressureTransition extends KeyTransition {
        constructor(srcState, tgtState, action) {
            super(srcState, tgtState, "keydown", action, (evt) => evt.code === "Escape" || evt.code === String(exports.KeyCode.escape));
        }
    }
    ...
    exports.MouseDownFSM = MouseDownFSM;
